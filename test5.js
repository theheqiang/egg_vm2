...
screen = {
    ...
    colorDepth: 24,
    height: 864,
    orientation: new function ScreenOrientation(){},
    pixelDepth: 24,
    width: 1536
}
...
BatteryManager.prototype.addEventListener = function(){};
...
HTMLDivElement.prototype.addEventListener = function addEventListener(type, func){
    debugger;
    RSEventList[type] = func;
}
HTMLScriptElement = function HTMLScriptElement (){};
HTMLBodyElement = function HTMLBodyElement(){};
HTMLBodyElement.prototype.appendChild = function appendChild(){};
HTMLBodyElement.prototype.removeChild = function removeChild(){};
...
setTimeout = function setTimeout(func, times, ...args){
    func[args] = args;
    RSTimeoutList.push(func);
}
...
document = {
    getElementsByTagName:function(tag){
        if(tag == "script"){
            ...
            script.src = "https://acstatic-dun.126.net/tool.min.js?v=27376833"
            return script
        }
    },
    documentElement: [],
    ...
    createElement:function(tag){
        ...
        }else if(tag.toLowerCase() == "canvas"){
...
!function(){
    window.initWatchman = window.initNEWatchman = function(){debugger;};
                    ...
                    (function() {
                            ...
                            function kc() {
                                ...
                                return d.map(function(d) {
                                    ...
                                    return "Chromium PDF Plugin::Portable Document Format::application/x-google-chrome-pdf~pdf"
                                })
                            }
                            function dd() {
                                var a = [];
                                ...
                                // u[b[3]] && (a = a.concat(kc()));
                                a = [
                                    "Chromium PDF Plugin::Portable Document Format::application/x-google-chrome-pdf~pdf",
...
!function(){
    ...
    var watchman =  new Watchman({
        ...
        "lastUsedVersion": "2.7.1_7c08033d",
