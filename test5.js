const setupEnv = require('D:\\Users\\Documents\\WeChat Files\\wxid_bzb72a7robq912\\FileStorage\\File\\2023-01\\zhvm(1)\\zhvm\\env.js');
...
// }
//
// !function(require, process, __filename, __dirname, module, exports, Buffer){
//     /** 1.0.0.20 */
...
//
// app.get('/dy', (req, res) => {
//     let aweme_id = req.query.aweme_id
//     // 7186660854031535399
//     v.open("GET", `/aweme/v1/web/comment/list/?device_platform=webapp&aid=6383&channel=channel_pc_web&aweme_id=${aweme_id}&cursor=0&count=20&item_type=0&insert_ids=&rcFT=&pc_client_type=1&version_code=170400&version_name=17.4.0&cookie_enabled=true&screen_width=1600&screen_height=900&browser_language=en-US&browser_platform=Win32&browser_name=Chrome&browser_version=109.0.0.0&browser_online=true&engine_name=Blink&engine_version=109.0.0.0&os_name=Windows&os_version=10&cpu_core_num=8&device_memory=8&platform=PC&downlink=7&effective_type=4g&round_trip_time=50&webid=7195383602862179840`, !0);
//     var xb = v.send(null)
//     res.send({"data":xb})
// });
//
